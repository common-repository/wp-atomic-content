...
Author URI: http://www.partage-it.com
License: MIT
...
function registerAtomicContentCpt() {
	...
	$labels = array(
		...
		"name_admin_bar"        => __("Blocks", "atomic-content"),
		"archives"              => __("Block Archives", "atomic-content"),
		"parent_item_colon"     => __("Parent block:", "atomic-content"),
		"all_items"             => __("All blocks", "atomic-content"),
		"add_new_item"          => __("Add New block", "atomic-content"),
		"add_new"               => __("Add New", "atomic-content"),
		"new_item"              => __("New block", "atomic-content"),
		"edit_item"             => __("Edit block", "atomic-content"),
		"update_item"           => __("Update block", "atomic-content"),
		"view_item"             => __("View block", "atomic-content"),
		"search_items"          => __("Search block", "atomic-content"),
		...
		"insert_into_item"      => __("Insert into block", "atomic-content"),
		"uploaded_to_this_item" => __("Uploaded to this block", "atomic-content"),
		"items_list"            => __("Blocks list", "atomic-content"),
		"items_list_navigation" => __("Blocks list navigation", "atomic-content"),
		"filter_items_list"     => __("Filter blocks list", "atomic-content"),
	);
	$args = array(
...
function atomicContent($id, $classes = array(), $spaceBefore = null, $spaceAfter = null, $display = true) {
	...
	array_unshift($classes, "atomic-content-block", "block-" . $id);
	$onlineStyle = array();
